...
public class Book_Select_Or_Update_Interface extends JFrame {
    ...
    Book_Select_Or_Update_Interface() {
        ...
        HomeIconLabel.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                BookCode = "";
                Book_Insert_Interface.Code = "";
                Book_Insert_Interface.Price = "";
                Book_Insert_Interface.Type = "";
                Book_Insert_Interface.Language = "";
                Book_Insert_Interface.Title = "";
                Book_Insert_Interface.AvailableChecked = false;
                Book_Insert_Interface.UnavailableChecked = false;
                new HomeInterface();
                // delay l el dispose
