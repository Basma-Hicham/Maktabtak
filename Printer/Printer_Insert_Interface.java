...
public class Printer_Insert_Interface extends JFrame {
    ...
    public class RoundJButton extends JButton {
        ...
        HomeIconLabel.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                NumOfPrintings = "";
                EndOfPrintingDate = "";
                Printer_Select_Or_Update_Interface.BookCode = "";
                new HomeInterface();
                // delay l el dispose
        ...
        Select_Or_UpdateIconLabel.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                new Printer_Select_Or_Update_Interface();
                // delay l el dispose
                Timer timer = new Timer(2000, event -> {
                    dispose();
                });
    ...
    public static void main(String[] args) {
        Printer_Insert_Interface p = new Printer_Insert_Interface();
    }
}
