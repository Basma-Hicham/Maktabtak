...
public class Printer_Select_Or_Update_Interface2 extends JFrame {
    ...
    private JLabel SelectAllDataButtonLabel, UpdateButtonLabel, PrinterTextLabel, Table_Row_TextLabel;
    ...
    Printer_Select_Or_Update_Interface2() {
        ...
        HomeIconLabel.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                Printer_Insert_Interface2.BookCode = "";
                Printer_Insert_Interface2.NumOfPrintings = "";
                Printer_Insert_Interface2.EndOfPrintingDate = "";
                BookCode = "";
                new HomeInterface2();
                // delay l el dispose
        ...
        PrinterTextLabel.setFont(new Font("K2D", Font.PLAIN, 45));
        PrinterTextLabel.setForeground(Color.WHITE);
        PrinterTextLabel.setBounds(96, 123, 220, 45);
        ...
        PrinterTableRec.setBounds(59 + 12, 251, 1638, 661);

        PrinterTextLabel = new JLabel("Printer");
        PrinterTextLabel.setForeground(Color.BLACK);
        PrinterTextLabel.setFont(new Font("Inter", Font.PLAIN, 115));
        PrinterTextLabel.setBounds(713, 466, 362, 149);
    ...
    public static void main(String[] args) {
        Printer_Select_Or_Update_Interface p = new Printer_Select_Or_Update_Interface();
    }
}
