...
public class Printer_Select_Or_Update_Interface extends JFrame {
    ...
    Printer_Select_Or_Update_Interface() {
        ...
        HomeIconLabel.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                Printer_Insert_Interface.BookCode = "";
                Printer_Insert_Interface.NumOfPrintings = "";
                Printer_Insert_Interface.EndOfPrintingDate = "";
                BookCode = "";
                new HomeInterface();
                // delay l el dispose
