...
public class OrderInterface_Borrow extends JFrame {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g2D.drawLine(0, 656, getWidth() - 10, 656);
    ...
    private ImageIcon HomeIcon , OrderInfoIcon , OrderInfoIconHovered , VisaRadioButtonIcon , CashRadioButtonIcon , VisaIcon , CashIcon;
    private JLabel IDLabel , FNameLabel , LNameLabel , EMailLabel , BDLabel , PhoneLabel , StreetLabel , CityLabel , PostalCodeLabel , BorrowDateLabel ,  AddPhoneButtonLabel , OrderButtonLabel;
    ...
    private RoundJTextField IDTextField , FNameTextField , LNameTextField , EMailTextField , BDTextField , PhoneTextField , StreetTextField , CityTextField , PostalCodeTextField , BorrowDateTextField; 
    ...
    OrderInterface_Borrow() {
        ...
        OrderInfoIconLabel.addMouseListener(new MouseListener() {
            @Override public void mouseClicked(MouseEvent e) {
                ...
                BorrowDate = BorrowDateTextField.getText();
        ...
        CityLabel.setBounds(944 , 356 , 88 , 65);
        ...
        BorrowDateLabel.setFont(new Font("K2D" , Font.PLAIN , 45));
        BorrowDateLabel.setBounds(944 , 452 , 300 , 45);

        BorrowDateTextField = new RoundJTextField(15);
        BorrowDateTextField.setText(BorrowDate);
        BorrowDateTextField.setFont(new Font("ZCOOL QingKe HuangYou", Font.PLAIN, 35));
        BorrowDateTextField.setForeground(Color.darkGray);
        BorrowDateTextField.setBounds(1277, 452, 265+157, 47);

        PhoneLabel = new JLabel("Phone");
        PhoneLabel.setForeground(Color.WHITE);
        PhoneLabel.setFont(new Font("K2D" , Font.PLAIN , 45));
        PhoneLabel.setBounds(161 , 788 , 130 , 45);
        ...
        AddPhoneButtonLabel.setBounds(505, 855, 169, 45);
            ...
            public void actionPerformed(ActionEvent e) {
                if (e.getSource().equals(OrderButton)) {
                    ...
                    if (v.ID(IDTextField.getText().trim()) && v.f_name(FNameTextField.getText().trim()) && v.l_name(LNameTextField.getText().trim())
                        ...
                        && v.postal(PostalCodeTextField.getText().trim()) && v.BorrowDate(BorrowDateTextField.getText().trim())) {
                        // afdy el textfields
                        IDTextField.setText("");
    ...
    public static void main(String[] args) {
        OrderInterface_Borrow b =  new OrderInterface_Borrow();
    }
}
