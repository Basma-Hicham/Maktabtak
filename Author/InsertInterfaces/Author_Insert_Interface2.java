...
public class Author_Insert_Interface2 extends JFrame {
    ...
    Author_Insert_Interface2() {
        ...
        HomeIconLabel.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                Author_Select_Or_Update_Interface2.ID = "";
                ID = "";
                FName = "";
                LName = "";
                EMail = "";
        ...
        Select_Or_UpdateIconLabel.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                new Author_Select_Or_Update_Interface2();
                // delay l el dispose
                Timer timer = new Timer(2000, event -> {
                    dispose();
                });
    ...
    public static void main(String[] args) {
        Author_Insert_Interface2 A = new Author_Insert_Interface2();
    }
}
