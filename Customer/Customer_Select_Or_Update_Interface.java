...
public class Customer_Select_Or_Update_Interface extends JFrame {
    ...
    private JLabel SelectAllDataButtonLabel, UpdateButtonLabel, CustomerTextLabel, Table_Row_TextLabel;
    private RoundJTextField IDTextFeild;
    private RoundJButton SelectButton, SelectAllDataButton, UpdateButton;
    private CustomerTableRec CustomerTableRec;
    private static String ID = "";

    Customer_Select_Or_Update_Interface() {
        ...
        CustomerTableRec.setBounds(59 + 12, 251, 1638, 661);

        CustomerTextLabel = new JLabel("Customer");
        CustomerTextLabel.setForeground(Color.BLACK);
        CustomerTextLabel.setFont(new Font("Inter", Font.PLAIN, 115));
        CustomerTextLabel.setBounds(650, 466, 562, 149);
